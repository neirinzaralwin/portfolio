    ...
    <>
      <Transition viewport={{ once: true }}>
        ...
        <div className="fixed bottom-0 w-full z-40 md:hidden">
          <div className="flex justify-center text-white/70 pb-6">
            <div className="inline-flex items-center justify-center px-6 py-3 rounded-full bg-black/50 backdrop-blur-md">
              <ul className="flex flex-row space-x-6 items-center">
                ...
                <li className="group">
                  <a
                    href="#contact"
                    className="px-3 py-2 rounded-full border border-white/50 flex items-center gap-2 group"
                    onClick={(e) => {
                      e.preventDefault();
                      handleLinkClick("contact");
                    }}
