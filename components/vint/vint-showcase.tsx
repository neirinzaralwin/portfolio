  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 60% 50% at 70% 40%, #668eab33 0%, transparent 70%)",
        }}
      />
      ...
      <div className="relative mt-10 md:mt-14 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
        <FadeIn className="lg:col-span-5 order-2 lg:order-1">
          ...
          <p className="mt-6 text-sm md:text-base text-gray-500 leading-relaxed max-w-xl">
            A structured marketplace for pre-loved fashion — listings, auctions,
            payment review, and commission billing in one place. Free to join;
            shops only pay commission on sales.
          </p>
        </FadeIn>

        <FadeIn className="lg:col-span-7 order-1 lg:order-2 flex justify-center lg:justify-end">
